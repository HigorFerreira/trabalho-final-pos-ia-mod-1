...
def parse_args():
    ...
    predict.add_argument("--mlp_hidden_layer_sizes", nargs='+', default=[50, 100, 50], help='Hidden layer neurons. Default 50 100 50')
    predict.add_argument("--mlp_activation", type=str, default='relu', help='Activation (relu, identity, logistic, tanh). Default relu')
    predict.add_argument("--mlp_max_iter", type=int, default=800, help='Max iterations. Default 800')
